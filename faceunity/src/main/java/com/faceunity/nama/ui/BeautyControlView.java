...
public class BeautyControlView extends FrameLayout implements TouchStateImageView.OnTouchStateListener {
    ...
    public void check(){
        int skinCheckedId = R.id.beauty_radio_skin_beauty;
        mSkinBeautyBoxGroup.check(skinCheckedId);
    }
    ...
    private void updateViewState() {
        ThreadHelper.getInstance().runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                int skinCheckedId = R.id.beauty_box_blur_level;
                mSkinBeautyBoxGroup.check(skinCheckedId);
                seekToSeekBar(skinCheckedId);
...
//        mFlFaceSkinItems.setVisibility(GONE);
    ...
    private void seekToSeekBar(final float value) {
        ThreadHelper.getInstance().runOnUiThread(new Runnable() {
            @Override
            public void run() {
...
//                }
    ...
    public void setFilterLevel(String filterName, float faceBeautyFilterLevel) {
        ...
        if (mFaceBeautyManager != null) {
            ...
            PreferenceUtil.setFilterParams(BeautyParameterModel.sFilterLevel);
        }
    }
        ...
        public void onBindViewHolder(HomeRecyclerHolder holder, final int position) {
            ...
            holder.itemView.setOnClickListener(new OnMultiClickListener() {
                ...
                protected void onMultiClick(View v) {
                    ...
                    if (mFaceBeautyManager != null) {
                        mFaceBeautyManager.setFilterName(BeautyParameterModel.sFilter.getName());
                        PreferenceUtil.setFilter(BeautyParameterModel.sFilter);
                    }
