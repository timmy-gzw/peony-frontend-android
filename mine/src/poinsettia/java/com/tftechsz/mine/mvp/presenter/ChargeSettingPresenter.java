...
public class ChargeSettingPresenter extends BasePresenter<IChargeSettingView> {
    ...
    private OptionsPickerView<String> mPvMessagePrice;  //
    ...
    public void messagePrice(Context context, ChargeItemDto chargeItem, int type, RelativeLayout relativeLayout, int coin) {
        ...
        mPvMessagePrice = new OptionsPickerBuilder(context, new OnOptionsSelectListener() {
            @Override
            public void onOptionsSelect(int options1, int option2, int options3, View v) {
                ...
                .setLayoutRes(R.layout.layout_pickerview_custom, new CustomListener() {
                    ...
                    public void customLayout(View v) {
                        ...
                        if (type == 1) {
                            title.setText("请选择消息价格");
                        } else if (type == 2) {
                            title.setText("请选择语音价格");
                        } else if (type == 3) {
                            title.setText("请选择视频价格");
                        }
                        v.findViewById(R.id.tv_finish).setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                mPvMessagePrice.returnData();
                                mPvMessagePrice.dismiss();
                            }
                        });
                    }
                })
