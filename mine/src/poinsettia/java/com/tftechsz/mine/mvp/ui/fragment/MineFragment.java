...
public class MineFragment extends BaseMvpFragment<IMineView, MinePresenter> implements IMineView, View.OnClickListener {
    ...
    protected int getLayout() {
        return CommonUtil.isGa() ?  R.layout.fragment_mine_ga :  R.layout.fragment_mine;
    }
    ...
    private void setUserInfo(UserInfo userInfo) {
        ...
        GlideUtils.loadRoundAvatarImage(getActivity(), mIvAvatar, userInfo.getIcon(), userInfo.getSex() == 1 ? R.mipmap.mine_ic_boy_default : R.mipmap.mine_ic_girl_default);
