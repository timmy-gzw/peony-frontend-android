...
public class ImproveInfoActivity extends BaseMvpActivity<IImproveInfoView, ImproveInfoPresenter> implements View.OnClickListener, IImproveInfoView {
    ...
    private LinearLayout mLlBoy, mLlGirl;  //男孩 女孩布局
    ...
    private void setSexView(int i) {
        switch (i) {
            case 0: //男
                ...
                mIvBoy.setImageResource(R.mipmap.mine_boy_selector);
                mIvGirl.setImageResource(R.mipmap.mine_girl_normal);
            ...
            case 1: //女
                ...
                mIvBoy.setImageResource(R.mipmap.mine_boy_normal);
                mIvGirl.setImageResource(R.mipmap.mine_girl_selector);
                break;
        }
    }
