...
public class TextClick extends ClickableSpan {
    ...
    public void onClick(View widget) {
        ...
        String title;
        if (type == 0) {
            link = (BuildConfig.DEBUG ? ApiConstants.HOST_H5_DEV : ApiConstants.HOST_H5) + "agreement.html?__app_name=" + Constants.WEB_PARAMS_APP_NAME;
            title = "用户协议";
            BaseWebViewActivity.start(mContext, title, link, 0, 8);
        } else {
            link = (BuildConfig.DEBUG ? ApiConstants.HOST_H5_DEV : ApiConstants.HOST_H5) + "policy.html?__app_name=" + Constants.WEB_PARAMS_APP_NAME;
            title = "隐私政策";
