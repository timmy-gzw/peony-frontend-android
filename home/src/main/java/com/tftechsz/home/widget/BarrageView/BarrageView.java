package com.tftechsz.home.widget.BarrageView;
...
public class BarrageView extends RelativeLayout {
    ...
    private final int DEFAULT_MAXTEXTSIZE = 15;
    ...
    private void showBarrage(final Barrage tb) {
        ...
        textView.setBackground(getResources().getDrawable(R.drawable.barrage_bg));
        textView.setPadding(textLeftPadding, textTopPadding, textRightPadding, textBottomPadding);

        textView.setTextSize((minTextSize + (maxTextSize - minTextSize)));
        textView.setText(tb.getContent());
        textView.setTextColor(tb.getColor());
        ...
        Animation anim = AnimationHelper.createTranslateAnim(getContext(), leftMargin, -BarrageTools.getScreenWidth(getContext()));
