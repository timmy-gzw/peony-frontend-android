...
public class RadarActivity extends BaseMvpActivity<IRadarView, RadarPresenter> implements RadarView.IScanningListener, View.OnClickListener, IRadarView {
    ...
    private ImageView mRadarView,mScaleAlphaImageView1,mScaleAlphaImageView2,mScaleAlphaImageView3;
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        mImgCenter = findViewById(R.id.img_center);
        mtvMatch = findViewById(R.id.tv_match);
    }
    ...
    protected void initData() {
        ...
        if (mType == 2) {   //视频
            ...
            mIvAvatar.setImageResource(R.mipmap.ic_center_avater_video);
            mImgCenter.setImageResource(R.mipmap.ic_voice_center_video);
            ...
            mIvRoundBig.setBackgroundResource(R.drawable.round_video);
            mIvAvatar.setImageResource(R.mipmap.ic_center_avater);
            mImgCenter.setImageResource(R.mipmap.ic_voice_center);
            mtvMatch.setTextColor(getResources().getColor(R.color.white));
            mTvMatchInterval.setTextColor(getResources().getColor(R.color.white));
        }
        initBus();
    }
