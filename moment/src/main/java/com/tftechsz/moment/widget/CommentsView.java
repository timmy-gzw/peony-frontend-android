...
import com.tftechsz.moment.entity.CommentListBean;
import com.tftechsz.common.entity.UserBean;
import com.tftechsz.moment.R;
import com.tftechsz.moment.other.CircleMovementMethod;
...
public class CommentsView extends LinearLayout {
    ...
    private View getView(final int position) {
        ...
        UserBean replyUser;
        if(item.getTo_user_id()!=0&& !TextUtils.isEmpty(item.getTo_user_name())){
        ...
        if(item.getUser_id() != 0 && item.getUser_name() != null){
     ...
     * @return
     */
    public SpannableString setClickableSpanContent(final String item, final int position, int user_id, CommentListBean bean) {
    ...
    public interface CommentListener{
        void Comment(int position, CommentListBean bean, int user_id);
    }
}
