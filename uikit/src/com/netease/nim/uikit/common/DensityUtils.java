...
public class DensityUtils {
    ...
    public static boolean isDpWithHW(Context mContext, int width, int height) {
        return getDisplay(mContext).getHeight() == height && getDisplay(mContext).getWidth() == width;
    }


    public static Display getDisplay(Context activity) {
        return ((WindowManager) activity.getApplicationContext().getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay();
    }
}  