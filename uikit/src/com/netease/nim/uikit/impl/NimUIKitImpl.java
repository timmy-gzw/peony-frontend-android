...
public final class NimUIKitImpl {
    ...
    // 会话窗口消息列表一些点击事件的响应处理函数
    private static SessionEventTipListener sessionTipListener;
...
//        ChatRoomMessageFragment.setChatRoomSessionCustomization(commonChatRoomSessionCustomization);
    ...
    public static SessionEventTipListener getSessionTipListener() {
        return sessionTipListener;
    }
    ...
    public static void setSessionTipListener(SessionEventTipListener sessionListener) {
        NimUIKitImpl.sessionTipListener = sessionListener;
    }
