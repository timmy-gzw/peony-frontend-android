...
public class MsgViewHolderGift extends MsgViewHolderBase implements MsgAdapter.OnScrollListener  {
    ...
    private void layoutByDirection() {
        if (isReceivedMessage()) {   //接收消息
            ...
            mTvGiftNum.setTextColor(context.getResources().getColor(R.color.black));
            mTvGiftBtn.setText("回赠礼物");
            mTvGiftBtn.setBackgroundResource(R.drawable.bg_record_tip_left);
            mTvGiftBtn.setTextColor(context.getResources().getColor(R.color.white));
            tvSend.setText("送给你");
            tvSend.setTextColor(context.getResources().getColor(R.color.black));
            mTvGift.setTextColor(context.getResources().getColor(R.color.black));
            ...
            mTvGiftNum.setTextColor(context.getResources().getColor(R.color.white));
            ...
            mTvGiftBtn.setBackgroundResource(R.drawable.bg_record_tip_right);
            mTvGiftBtn.setTextColor(context.getResources().getColor(R.color.colorPrimary));
            tvSendRight.setText("送出礼物");
            tvSendRight.setTextColor(context.getResources().getColor(R.color.white));
            mTvGift.setTextColor(context.getResources().getColor(R.color.white));
