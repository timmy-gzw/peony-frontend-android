package com.tftechsz.common.music.manager;
...
import com.tftechsz.common.music.util.CoverLoader;

/**
 * 包 名 : com.tftechsz.common.music.manager
 * 描 述 : TODO
 */
    ...
    public void updateMetaData(AudioBean music) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            metaData.putLong(MediaMetadataCompat.METADATA_KEY_NUM_TRACKS,
                    BaseMusicHelper.get().getMusicList().size());
        }
