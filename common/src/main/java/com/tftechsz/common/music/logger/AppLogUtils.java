package com.tftechsz.common.music.logger;
...
/**
 * 包 名 : com.tftechsz.common.music.logger
 * 描 述 : TODO
 */
    ...
    public static class Config {
        private Config() {
            ...
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                ...
                sDefaultDir = BaseApplication.getInstance().getExternalCacheDir() + FILE_SEP + "log" + FILE_SEP;
            else {
                sDefaultDir = BaseApplication.getInstance().getCacheDir() + FILE_SEP + "log" + FILE_SEP;
            }
        }
