...
public class MySegmentTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorMarginLeft = ta.getDimension(R.styleable.MySegmentTabLayout_tl_indicator_margin_left, dp2px(0));
        mIndicatorMarginTop = ta.getDimension(R.styleable.MySegmentTabLayout_tl_indicator_margin_top, 0);
        mIndicatorMarginRight = ta.getDimension(R.styleable.MySegmentTabLayout_tl_indicator_margin_right, dp2px(0));
        ...
        mDividerWidth = ta.getDimension(R.styleable.MySegmentTabLayout_tl_divider_width, dp2px(1));
        mDividerPadding = ta.getDimension(R.styleable.MySegmentTabLayout_tl_divider_padding, 0);

        mTextsize = ta.getDimension(R.styleable.MySegmentTabLayout_tl_textSize, sp2px(13f));
        ...
        mTabWidth = ta.getDimension(R.styleable.MySegmentTabLayout_tl_tab_width, dp2px(-1));
        mTabPadding = ta.getDimension(R.styleable.MySegmentTabLayout_tl_tab_padding, mTabSpaceEqual || mTabWidth > 0 ? dp2px(0) : dp2px(10));
        ...
        mBarStrokeWidth = ta.getDimension(R.styleable.MySegmentTabLayout_tl_bar_stroke_width, dp2px(1));
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            tabView = View.inflate(mContext, R.layout.layout_tab_my_segment, null);
            tabView.setTag(i);
            addTab(i, tabView);
        }
    ...
    private void addTab(final int position, View tabView) {
        AutoFitTextView tv_tab_title = (AutoFitTextView) tabView.findViewById(R.id.tv_tab_title);
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void onAnimationUpdate(ValueAnimator animation) {
        MySegmentTabLayout.IndicatorPoint p = (MySegmentTabLayout.IndicatorPoint) animation.getAnimatedValue();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mIndicatorDrawable.setStroke(ConvertUtils.dp2px(1), Utils.getColor(R.color.colorPrimary));
    ...
    private MySegmentTabLayout.IndicatorPoint mCurrentP = new MySegmentTabLayout.IndicatorPoint();
    private MySegmentTabLayout.IndicatorPoint mLastP = new MySegmentTabLayout.IndicatorPoint();

    class PointEvaluator implements TypeEvaluator<IndicatorPoint> {
        @Override
        public MySegmentTabLayout.IndicatorPoint evaluate(float fraction, MySegmentTabLayout.IndicatorPoint startValue, MySegmentTabLayout.IndicatorPoint endValue) {
            float left = startValue.left + fraction * (endValue.left - startValue.left);
            float right = startValue.right + fraction * (endValue.right - startValue.right);
            MySegmentTabLayout.IndicatorPoint point = new MySegmentTabLayout.IndicatorPoint();
            point.left = left;
            point.right = right;
            return point;
        }
