...
public class VerticalLoopLayoutManager extends LinearLayoutManager {

    public VerticalLoopLayoutManager(Context context) {
        super(context);
    }

    public VerticalLoopLayoutManager(Context context, int orientation, boolean reverseLayout) {
        super(context, orientation, reverseLayout);
    }

    public VerticalLoopLayoutManager(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
