...
public class BubbleLayout extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        //背景颜色
        int backGroundColor = ta.getColor(R.styleable.BubbleLayout_background_color, Color.TRANSPARENT);
        //阴影颜色
        ...
        mRadius = ta.getDimensionPixelSize(R.styleable.BubbleLayout_bub_radius, 0);
        //三角形方向
