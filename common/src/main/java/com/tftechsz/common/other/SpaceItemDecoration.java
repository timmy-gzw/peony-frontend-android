...
public class SpaceItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public SpaceItemDecoration(int hSpacing, int vSpacing, boolean includeEdge) {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        if (parent.getLayoutManager() instanceof GridLayoutManager) {
            ...
            getLinearLayoutOffsets(outRect, position, orientation);
        }
    }

    private void getLinearLayoutOffsets(Rect outRect, int position, int orientation) {
