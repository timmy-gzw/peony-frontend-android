 ...
 * 描 述 : TODO
 */
public abstract class MyClassicsAbstract<T extends MyClassicsAbstract> extends SimpleComponent implements RefreshComponent {
    ...
    public MyClassicsAbstract(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        setPadding(getPaddingLeft(), SmartUtil.dp2px(0), getPaddingRight(), SmartUtil.dp2px(0));
