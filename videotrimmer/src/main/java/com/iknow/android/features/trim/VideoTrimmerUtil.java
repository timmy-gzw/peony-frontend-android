...
public class VideoTrimmerUtil {
    ...
    public static final long MIN_SHOOT_DURATION = Interfaces.MIN_TRIM_VIDOE_TIME;// 最小剪辑时间
    public static final int VIDEO_MAX_TIME = Interfaces.MAX_TRIM_VIDOE_TIME;
    public static final long MAX_SHOOT_DURATION = VIDEO_MAX_TIME * 1000L;//视频最多剪切多长时间
    ...
    public static void trim(Context context, String inputFile, String outputFile, long startMs, long endMs, final VideoTrimListener callback) {
        ...
        epVideo.clip(startMs / 1000.f, (endMs - startMs) / 1000.f);
        EpEditor.OutputOption outputOption = new EpEditor.OutputOption(outputFile);
        String finalOutputFile = outputFile;
        EpEditor.exec(epVideo, outputOption, new OnEditorListener() {
            @Override
            public void onSuccess() {
                callback.onFinishTrim(finalOutputFile, (int) ((endMs - startMs) / 1000.f));
            }
            ...
            public void onProgress(float progress) {
                ...
                //这里获取处理进度
                Utils.logE("onProgress:" + progress);
            }
        });*/
    }
