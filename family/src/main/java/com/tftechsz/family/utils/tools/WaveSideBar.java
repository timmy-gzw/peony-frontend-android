...
public class WaveSideBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mTextSize = context.getResources().getDimensionPixelSize(R.dimen.dp_size_10);
        mHintTextSize = context.getResources().getDimensionPixelSize(R.dimen.dp_size_32);
        ...
        if (attrs != null) {
            ...
            mCircleRadius = a.getDimensionPixelSize(R.styleable.waveSideBar_circleRadius, context.getResources().getDimensionPixelSize(R.dimen.dp_20));
            a.recycle();
        }
